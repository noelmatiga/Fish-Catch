...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2022 at 02:20 AM
...
INSERT INTO `tbl_fish_catch` (`catch_id`, `fisherman_id`, `vessel_id`, `fish`, `kilos`, `lat`, `longh`, `market_id`, `catch_date`, `catch_time`) VALUES
(1, 2, 1, 'bangus', 12, 0, 0, 3, '2022-04-28', '07:12:00');
...
INSERT INTO `tbl_vessel` (`vessel_id`, `vessel_name`, `vessel_desc`, `fisherman_id`, `vessel_img`, `date_registered`) VALUES
...
--
ALTER TABLE `tbl_fish_catch`
  MODIFY `catch_id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
