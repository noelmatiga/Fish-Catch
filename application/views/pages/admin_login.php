...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>FCMSCFP | Admin Login</title>
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <section class="site-section site-section-light site-section-top themed-background-dark">
                <div class="container">
                    <h1 class="text-center animation-slideDown"><i class="fa fa-arrow-right"></i> <strong>Admin Log In</strong></h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 col-lg-4 col-lg-offset-4 site-block">
                            <!-- Log In Form -->
                            <form action="<?php echo base_url('check_login') ?>" method="post" id="form-log-in" class="form-horizontal">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 text-center">
                            <h4 class="footer-heading"><span>2019</span> &copy; <a href="#">CFCMS | Carigara Fish Catch Monitoring System</a></h4>
